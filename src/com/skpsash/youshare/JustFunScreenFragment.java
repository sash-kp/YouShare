...
public class JustFunScreenFragment extends Fragment {

	private ListView listView;
	private FeedListAdapter listAdapter;
	private List<FeedItem> feedItems;
	private String URL_FEED = "http://skpsash.site50.net/get_posts_data/getJsonFromPostsForFun.php";
	ProgressBar pb;
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {

		View rootView = inflater.inflate(R.layout.fragment_justfun, container, false);
		listView = (ListView) rootView.findViewById(R.id.listFun);
	...
	public void onActivityCreated( Bundle savedInstanceState) {
		...
		pb = (ProgressBar) getActivity().findViewById(R.id.progressfun);
