...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "cloud_contacts.db";
    ...
    public String getUserId(){
    	String userId = null;
    	String selectQuery = "SELECT uid FROM " + TABLE_LOGIN;
    	SQLiteDatabase db = this.getReadableDatabase();
    	Cursor cursor = db.rawQuery(selectQuery, null);
         // Move to first row
         cursor.moveToFirst();
    ...
    public String getUserName(){
    	...
    	String selectQuery = "SELECT uname FROM " + TABLE_LOGIN;
    	SQLiteDatabase db = this.getReadableDatabase();
    	Cursor cursor = db.rawQuery(selectQuery, null);
         // Move to first row
         cursor.moveToFirst();
