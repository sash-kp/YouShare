...
public class PoliticsScreenFragment extends Fragment {

	private ListView listView;
	private FeedListAdapter listAdapter;
	private List<FeedItem> feedItems;
	private String URL_FEED = "http://skpsash.site50.net/get_posts_data/getJsonFromPostsForPolitics.php";
	ProgressBar pb;
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		listView = (ListView) rootView.findViewById(R.id.listPolitics);
	...
	public void onActivityCreated( Bundle savedInstanceState) {
		...
		pb = (ProgressBar) getActivity().findViewById(R.id.progresspolitics);
