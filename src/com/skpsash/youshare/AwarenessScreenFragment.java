...
public class AwarenessScreenFragment extends Fragment {

	private ListView listView;
	private FeedListAdapter listAdapter;
	private List<FeedItem> feedItems;
	private String URL_FEED = "http://skpsash.site50.net/get_posts_data/getJsonFromPostsForAwareness.php";
	ProgressBar pb;
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {

		View rootView = inflater.inflate(R.layout.fragment_awareness, container, false);
		listView = (ListView) rootView.findViewById(R.id.listAware);
	...
	public void onActivityCreated( Bundle savedInstanceState) {
		...
		pb = (ProgressBar) getActivity().findViewById(R.id.progressaware);
