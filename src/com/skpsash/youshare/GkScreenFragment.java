...
public class GkScreenFragment extends Fragment {

//	private static final String TAG = GkScreenFragment.class.getSimpleName();
	private ListView listView;
	private FeedListAdapter listAdapter;
	private List<FeedItem> feedItems;
	ProgressBar pb;
	private String URL_FEED = "http://skpsash.site50.net/get_posts_data/getJsonFromPostsForGk.php";
	@Override
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			Bundle savedInstanceState) {

		
		View rootView = inflater.inflate(R.layout.fragment_gk, container, false);
